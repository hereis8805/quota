...
import { getExercises, getMonthData, computeLogs } from '@/lib/storage'
...
export default function CalendarClient({ year, month }: Props) {
  ...
  useEffect(() => {
    ...
    const data = getMonthData(year, month, exs)
    setExercises(exs)
